...
namespace FunctionApp3
{
    public static class Function1
    {
        ...
        // reformat DateTime, as / and : not usable in filenames
            ...
            string[] dates = new string[] { new DateTime(2008, 01, 02).ToString(), new DateTime(2008, 12, 02).ToString(), new DateTime(2008, 02, 12).ToString(), new DateTime(2008, 11, 12).ToString() };

            foreach (var dateFull in dates)
            {
